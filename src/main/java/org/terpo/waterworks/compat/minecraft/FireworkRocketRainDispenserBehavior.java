...
public class FireworkRocketRainDispenserBehavior extends BehaviorDefaultDispenseItem {

	private final WeatherRocketFunction<EntityFireworkRocketRain, World, Vec3d, ItemStack> createEntityFunction;

	public FireworkRocketRainDispenserBehavior(
			WeatherRocketFunction<EntityFireworkRocketRain, World, Vec3d, ItemStack> createEntityFunction) {
