...
@OnlyIn(Dist.CLIENT)
public class RenderFireworkRocketAntiRain extends EntityRenderer<EntityFireworkRocketAntiRain> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WaterworksReference.MODID,
			"textures/items/firework_anti_rain.png");
	private final ItemRenderer itemRenderer;

	public RenderFireworkRocketAntiRain(EntityRendererManager entityRenderManager) {
	...
	public void doRender(EntityFireworkRocketAntiRain entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
		Waterworks.LOGGER.error("doRender");
